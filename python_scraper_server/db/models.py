...
class Event(Base):
    ...
    registration_deadline = Column(DateTime, nullable=False) # data fine iscrizioni
    location = Column(String, nullable=False) # luogo evento
    max_participants = Column(Integer, nullable=False) # massimo numero di partecipanti
    max_groups = Column(Integer, nullable=False) # massimo numero gruppi
    min_people_per_group = Column(Integer, nullable=False) # minimo numero di persone per gruppo
    max_people_per_group = Column(Integer, nullable=False) # massimo numero di persone per gruppo
    registration_cost = Column(Float, nullable=False) # costo di iscrizione a persona
